...
namespace CleanArchitecture.Migrations
{
    ...
    [Migration("20250226142052_ADDNewColumnToBaseModel")]
    partial class ADDNewColumnToBaseModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "04203de7-2e89-48d5-8132-f6cda5dd1a84",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJdnliWDAaDDLydGYxoWqEXY8Geg0xjCAe05RmaxIYr5LvrwjEeW4CWVlxjGtWxh7w==",
